...
import { User, Phone, Building2, MapPin, LogOut, Shield, Bell, ArrowLeft, Pencil, Loader2, Sun, Moon } from "lucide-react";
        ...
        {editOpen && (
          <>
            ...
            <motion.div initial={{ y: "100%" }} animate={{ y: 0 }} exit={{ y: "100%" }}
              ...
              className="fixed bottom-0 left-0 right-0 z-50 bg-card rounded-t-3xl border-t border-border p-6 space-y-4">
              <div className="w-10 h-1 bg-border rounded-full mx-auto mb-2" />
              <h2 className="font-display font-bold text-lg text-foreground">Edit Profile</h2>
              <p className="text-xs text-muted-foreground -mt-2">Department and ward are managed by your administrator.</p>
              {[
