...
import { User, Mail, Phone, MapPin, LogOut, FileText, CheckCircle, Users } from "lucide-react";
    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="px-5 -mt-6">
        <motion.div
          ...
          className="bg-card rounded-2xl border border-border shadow-sm p-4 grid grid-cols-3 gap-4 mb-6"
        >
          {stats.map(s => (
